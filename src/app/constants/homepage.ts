export const data = {
    ...
    experience: [
        {
            ...
            description: 'Развитие команды фронтенд-разработки, формирование процессов и внедрение инструментов, направленных на стандартизациию работы команды.'
        },
        {
    ...
    recommendations: [
        ...
        },
        {
            docLink: '/docs/RS.png',
            iconId: 'rs',
            desc: "В обязанности Марии, как руководителя фронтнд направления, входиn: распределение задач, управление проектами, развитие команды, разработка и внедрение процессов, оnboarding специалистов и инженерные улучшения.",
            name: 'BrainRocket',
            position: 'компания'
        },
    ],
