export const data = {
    ...
    experience: [
        ...
        },
        {
            ...
            description: 'Как старший верстальщик в компании Webvork, помогала коллегам по команде и создала более 7 лендингов: neologistics.it, it8.hepasanol.com, it13.prostatixultra.com, de3.blackpearloriginal.com, it2.blackpearloriginal.com, it3.cystinorm.com и тд (HTML, CSS, JS). Запустила первую версию конструктора лендингов (Vue).'
        },
        {
            title: 'Наставник Веб Верстальщик',
            date: 'Март 2015 – 2020',
            description: 'Являлась наставником базового и продвинутого курса HTML Academy по верстки. Помогла более 40 студентам закончить курс и получить сертификаты.'
        },
        {
    ...
    recommendations: [
        ...
        },
        {
            ...
            name: 'Роман Аблаев',
            position: 'продуктовый менеджер, Webwork'
        },
        {
    ...
    reviews: [
        ...
        {
            desc: 'Маша, привет, походу мне нужна будет еще твоя помощь уже на этих выходных на майских. У меня проблемы с центровками у элементов. Сможешь мне два часика времени уделить на ближайших выходных в любое удобное для тебя время',
            name: 'Александр',
            position: 'фронтенд разработчик'
        },
        {
